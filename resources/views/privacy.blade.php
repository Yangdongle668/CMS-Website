...
<section class="py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-8">Privacy Policy</h1>
        ...
        <div class="prose prose-lg max-w-none space-y-6">
            ...
            <ul class="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>To monitor and analyze usage trends and gather statistical information</li>
                <li>To respond to your inquiries and customer support requests</li>
            </ul>

            <h2 class="text-2xl font-bold text-gray-800 mt-8">4. Security of Data</h2>
            <p class="text-gray-600">
                The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your personal information, we cannot guarantee its absolute security.
            </p>

            <h2 class="text-2xl font-bold text-gray-800 mt-8">5. Contact Us</h2>
            <p class="text-gray-600">
